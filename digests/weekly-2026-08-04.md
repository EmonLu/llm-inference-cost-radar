...
## 4. TokTier: Exact Stateful Tokenization for Agentic LLM Serving
...
## 5. Topology-Aware Data Movement for Disaggregated GPU Inference
...
## 7. Mixture-of-Translators: Translating KV Caches Across Heterogeneous Large Language Models
...
## 8. TrimMoE A communication aware and adaptive depth framework for distributed edge inference
...
## 9. REFLEX: Rethinking MoE Inference as Refinement-Aware Compute Allocation in Diffusion Language Models
...
## 10. MoPET: Parameter-Efficient Mixture-of-Experts for Unified Medical Image Classification
...
## 12. Rethinking AI Cloud Infrastructure for Agentic Serving Systems with the Aries Experimentation Framework
...
## 14. Tevatron Meets Megatron: Expert-Parallel LLM Reranker Training on an Academic Budget
...
## 15. An eightfold equivalence-preserving speedup of the JUNO OMILREC vertex and energy reconstruction
...
## 17. An Internet for the KV Cache: Rethinking Classical Infrastructure Boundaries in the LLM Inference Age
...
## 18. Broadcast Rate Limits in Wi-Fi: A Forgotten Bottleneck for Collaborative Edge LLM Inference
...
## 19. Smoothing the Ramp, Not the Peak: Scheduling-Induced Power Dynamics of LLM Inference and Their Grid-Scale Consequences
...
## 20. MADE: Belief-Driven Dual-Agent Coordination for Autonomous Model Deployment
...
## 21. DeltaServe: Host-Agnostic Co-Serving of Inference and Fine-Tuning for LLMs
...
## 22. Building a Process-Modeling Tool using Agentic AI: An Experience Report on PM4Py-UCM
...
## 23. Studying quantization trade-offs for efficient inference deployment in machine translation
...
- 链接: [abs](https://arxiv.org/abs/2607.29397) | [pdf](https://arxiv.org/pdf/2607.29397v1)

## 24. MerchantBench: Benchmarking LLM Agents for Long-Term Coherence in E-Commerce Operations
...
## 25. Practical Online KV Cache Compaction for LLM Agents: An Empirical Study
...
## 4. FBTriton Infra: Upstream Ingestion, Hierarchical Validation, Ideals vs Realities
