...
## 6. UltraEP: Unleash MoE Training and Inference on Rack-Scale Nodes with Near-Optimal Load Balancing
...
## 7. SAC: Disaggregated KV Cache System for Sparse Attention LLMs with CXL
...
## 8. TetriServe: Efficiently Serving Mixed DiT Workloads
...
## 9. OmniPlan: An Adaptive Framework for Timely and Near-Optimal Network Planning Optimization
...
## 10. Agent trajectories as programs: fingerprinting and programming coding-agent behavior
...
## 12. Oranits: Mission Assignment and Task Offloading in Open RAN-based ITS using Metaheuristic and Deep Reinforcement Learning
...
## 14. Before the Pull Request: Mining Multi-Agent Coordination
...
## 18. Beyond the GUI Paradigm: Do Mobile Agents Need the Phone Screen?
...
## 20. Beyond Prediction: Tail-Aware Scheduling for LLM Inference
...
## 21. Agentic AI-based Framework for Mitigating Premature Diagnostic Handoff and Silent Hallucination in Healthcare Applications
...
## 22. The Proxy Knows Too Much: Sealing LLM API Routers with Attested TEEs
...
## 23. Contagion Networks: Evaluator Bias Propagation in Multi-Agent LLM Systems
...
## 24. LUMEN: Coordinated Failure Recovery for Distributed LLM Serving
...
## 25. Open-SWE-Traces: Advancing Dual-Mode Multilingual Distillation for Software Engineering Agents
