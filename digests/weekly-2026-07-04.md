...
## 11. HYPIC: Accelerating Hybrid-Attention LLM Serving with Position-Independent Caching
...
## 13. Hardware-Enforced Semantic Coordination for Safety-Critical Real-Time Autonomous Systems
...
## 16. When Agents Do Not Stop: Uncovering Infinite Agentic Loops in LLM Agents
...
## 17. MxGLUT: A Reconfigurable LUT-Centric Broadcast Dataflow Accelerator for Mixed-Precision GEMM
...
## 18. SWE-INTERACT: Reimagining SWE Benchmarks as User-Driven Long-Horizon Coding Sessions
...
## 19. ContextSniper: AntTrail's Token-Efficient Code Memory for Repository-Level Program Repair
...
## 20. Vehicle Routing Problem Meets Large Language Models: An Overview and Perspectives
...
## 21. Reasoning effort, not tool access, buys first-try reliability in agentic code generation: an observational study
...
## 22. Diverse Evidence, Better Forecasts: Multi-Agent Deliberation Under Information Asymmetry
...
## 24. Adoption and Impact of Command-Line AI Coding Agents: A Study of Microsoft's Early 2026 Rollout of Claude Code and GitHub Copilot CLI
...
## 25. Cheap Code, Costly Judgment: A Case Study on Governable Agentic Software Engineering
