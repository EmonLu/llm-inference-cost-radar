...
## 5. Where Is the Cost of Third-Party API Routers in Agentic Software Development?
...
## 7. SmartGen: Seamless Disaggregated LLM Inference with Selective KV Cache Transfer
...
## 9. $Σ$-Mem: An Online Reliability Memory for LLM-based Multi-Agent Systems
...
## 10. AgenticER: the next frontier in Entity Resolution
...
## 12. From Expert Reduction to Behavioral Divergence: Tracing Numerical State through Sparse MoE Inference
...
## 13. A Sparse Glimpse of the Whole: Train-Free Self-Speculative Decoding
...
## 14. Agentic Method for Deterministic Validation of Legacy Code Migration
...
## 15. MANTA: Multi-Agent Network Topology Adaptation for Self-Evolving Multi-Agent Systems
...
## 16. An Empirical Study of Coordination Mode as the First-Class Citizen in From-Scratch Multi-Agent Coding
...
## 17. Route by Kinematics, Act by Observation: Kinematics-Supervised Expert Routing in MoE-Augmented VLA
...
## 18. Agent Harness Distillation: Inference-Time Harness Extraction and Exploitation in Autonomous Multi-Agent Systems
...
## 19. MIND: Lightweight and Effective Memory Injection Defense for LLM Agents via Intent-Aware Information Bottleneck
...
## 20. Emission-Forecasting-Based Spatial-Temporal Carbon Response: A Multi-Agent Attention-Enhanced Deep Learning Framework
...
## 21. SkillGate: Cost Efficient Runtime Malicious Skill File Detection in Coding Agents
...
## 22. A Few Words Go a Long Way: Language Guided Robot Policy Synthesis
...
## 23. Scaling LLM-Driven Multi-Agent Systems: Design Principles and Architectural Scalability Analysis
...
## 24. From Understanding to Action: Feedback-Grounded Policy Discovery for Generative Recommendation
...
## 25. UniMem: Complementary Episodic-to-Parametric Memory for Boundary-Agnostic Task Streams
