...
## 5. Characterizing CPU-Induced Slowdowns in Multi-GPU LLM Inference
...
## 11. Disagree to Explore, Agree to Commit: Routing-Guided Test-Time Scaling for Software Agents
...
## 12. Agentic Autoresearch for Cell-Edge Power Control: Radically Redefining the Researcher's Role
...
## 13. Groundhog Bit-Flip Attack: Seeding Infinite Generation Loops in Mixture-of-Experts LLMs through Bit Flips
...
## 14. A Few Pages of Markdown: Committed AI Configuration and Lower Quality Cost after Coding-Agent Adoption
...
## 15. AsymSpec: Context-Asymmetric Speculative Decoding for Agentic LLMs
...
## 16. Can Coding Agents Build Robust Baselines? A Skill-Based Approach for Automating the Medical Imaging Model-Development Pipeline
...
## 17. MSM-Mem: A Universal Medical Structured Multimodal Memory Framework for Medical AI Agents
...
## 18. Tunable Tool-Call Rates in LLM Agents via Representation Steering
...
## 19. CRAM: Centroid-Routing and Adaptive MoE for Multimodal Continual Instruction Tuning
...
## 20. Cost-Utility Alignment in LLM Agent Trajectories:Profiling,Attribution,Diagnosis,Adaptation,and Evaluation
...
## 21. AgentSpec: Speculative Decoding for Batch Inference of LLM Agents
...
## 22. Routed Graph Handoff: Adaptive Format Selection for Multi-Agent LLM Delegation
...
## 23. Paritok-4B: Intent-Conditioned Context Compression for Coding Agents
...
## 24. Meta-Learning Where to Allocate Experts: Task-Conditioned Layer-Wise Compression for MoEs
...
## 25. A Unified Framework for Fair and Personalized Decentralized Learning under Communication Constraints
