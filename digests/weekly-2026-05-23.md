...
## 9. Llamas on the Web: Memory-Efficient, Performance-Portable, and Multi-Precision LLM Inference with WebGPU
...
## 11. LogRouter: Adaptive Two-Level LLM Routing for Log Question Answering in Big Data Systems
...
## 12. Maestro: Reinforcement Learning to Orchestrate Hierarchical Model-Skill Ensembles
...
## 13. 1GC-7RC: One Graphic Card -- Seven Research Challenges! How Good Are AI Agents at Doing Your Job?
...
## 14. LCGuard: Latent Communication Guard for Safe KV Sharing in Multi-Agent Systems
...
## 16. From Runnable to Shippable: Multi-Agent Test-Driven Development for Generating Full-Stack Web Applications from Requirements
...
## 17. PEEK: Context Map as an Orientation Cache for Long-Context LLM Agents
...
## 19. MOSS: Self-Evolution through Source-Level Rewriting in Autonomous Agent Systems
...
## 20. SSV: Sparse Speculative Verification for Efficient LLM Inference
...
## 21. MemRepair: Hierarchical Memory for Agentic Repository-Level Vulnerability Repair
...
## 22. Compiling Agentic Workflows into LLM Weights: Near-Frontier Quality at Two Orders of Magnitude Less Cost
...
## 23. Does Code Cleanliness Affect Coding Agents? A Controlled Minimal-Pair Study
...
## 24. F-TIS: Harnessing Diverse Models in Collaborative GRPO
...
## 25. Code Generation by Differential Test Time Scaling
