...
- 链接: [abs](https://arxiv.org/abs/2607.04371) | [pdf](https://arxiv.org/pdf/2607.04371v1)
...
## 3. Prima.cpp: Fast 30-70B LLM Inference on Heterogeneous and Low-Resource Home Clusters
...
## 6. Adaptive Inference Batching using Policy Gradients
...
## 7. Is Your NPU Ready for LLMs? Dissecting the Hidden Efficiency Bottlenecks in Mobile LLM Inference
...
## 9. Council Mode: A Heterogeneous Multi-Agent Consensus Framework for Reducing LLM Hallucination and Bias
...
- 链接: [abs](https://arxiv.org/abs/2607.04244) | [pdf](https://arxiv.org/pdf/2607.04244v1)

## 11. Quantize the Target, Quantize the Drafter: Efficient Inference with Qwen3.5-4B
...
## 15. PuzzleMoE: Efficient Compression of Large Mixture-of-Experts Models via Sparse Expert Merging and Bit-packed inference
...
## 16. Data Driven Optimization of GPU efficiency for Distributed LLM-Adapter Serving
...
## 17. Multi-Turn Distributed Inference with Mixture of Experts for 6G Edge--Cloud Networks
...
## 18. Worldscape-MoE: A Unified Mixture-of-Experts World Model for Scalable Heterogeneous Action Control
...
## 19. UBEP: Re-architecting Expert Parallelism Communication Library for Production Superpods
...
## 20. BrownoutMoE: Structure-Aware Expert Grouping for Efficient and Accurate LLM Web-based Services
...
## 21. SPORK: Self-Speculative Forking to Accelerate Agentic LLM Inference
...
## 23. Online Linear Programming for Multi-Objective Routing in LLM Serving
...
## 24. KARA: Efficient Reasoning LLM Serving via Sliding-Window KV Cache Compression
...
## 25. Optimal-Agent-Selection: State-Aware Routing Framework for Efficient Multi-Agent Collaboration
