...
- 链接: [abs](https://arxiv.org/abs/2607.13093v2) | [pdf](https://arxiv.org/pdf/2607.13093v2)
...
## 4. QUADS: Stabilizing NVFP4 Reinforcement Learning for MoE via QUantization-error Alignment across Dual Sides
...
## 10. Scalable LLM Agent Tool Access in the Cloud
...
## 13. Agentic Routing: The Harness-Native Data Flywheel
...
## 14. JoyNexus: Service-Oriented Multi-Tenant Post-Training for VLA Models
...
- 中文解读: 这项工作主要关注Cost-efficient LLM inference，核心内容是《A JoLT for the KV Cache: Near-Lossless KV Cache Compression via Joint Tucker and JL-Residual Allocation for LLMs》在 arXiv API 这一方向上的推进。通过 KV cache 优化长上下文推理成本。从实验上看，A randomized-SVD variant, FlashJoLT, delivers a 5-13x compression-time speedup at 1024-token context and matched quality.
...
- 链接: [abs](https://arxiv.org/abs/2607.12550v2) | [pdf](https://arxiv.org/pdf/2607.12550v2)
...
## 19. Are LLM-Generated GPU Kernels Production-Ready? A Trace-Driven Benchmark and Optimization Agent
...
## 20. Less Experts, Faster Decoding: Cost-Aware Speculative Decoding for Mixture-of-Experts
...
- 分类: cs.SE, cs.AI
- 中文解读: 这项工作主要关注Coding agent routing、Heterogeneous MoE inference、LLM routing，核心内容是《Inference Economics of Enterprise Coding Agents: A Case Study of Cloud vs. On-Premise LLMs》在 arXiv API 这一方向上的推进。与 agent 系统/工作流有关，纳入重点跟踪。从实验上看，At comparable gross code churn, the local configuration was associated with a far higher defect-repair burden: a Fix Commit Ratio (FCR) of 74.9% versus 45.9%, with the odds of a commit being a repair 2.6 to 4.9 times higher within every difficulty tier (Mantel-Haenszel OR = 3.61).
...
## 25. Diagnosing Overhead in Dispatch Operations: Cross-architecture Observatory
...
## 2. TML Inkling on vLLM: Day-0 Support with Optimized Performance
...
## 3. Keeping vLLM Production Quality: A Look Inside CI, Benchmarking, and the Release Process
