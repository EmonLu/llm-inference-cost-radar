...
## 3. Epoch: Compiling Diffusion Blocks for Sparse MoE Serving
...
## 4. AgentServeSim: Serving-System Simulation and Policy Search for LLM Agent Programs
...
## 5. Typed Federated Artifacts for the Agentic Web:Sharing Tool-Routing Knowledge Across Frozen,Heterogeneous LLM Agents
...
## 7. EcoFair: Energy-Efficient Inference Routing for Edge AI under Data Degradation
...
## 8. Distribution-Consistent Inference for Dynamic Sparse Mixture-of-Experts
...
## 9. Unified AI Gateway: A Framework for Joint Model Routing and KV Cache Management
...
## 11. EStream: Fast and Memory-Efficient MoE Prefill through Expert Virtualization on Mobile NPUs
...
## 12. HDA-MoE: Hybrid Parallelism and Dynamic, Adaptive Scheduling for Mixture-of-Experts with 3D Near-Memory Processing
...
## 13. Where Is the Tradeoff in Using Third-Party API Routers for Agentic Software Development?
...
## 16. Less is MoE: Trimming Experts in Domain-Specialist Language Models
...
## 18. HoneyRoute: Honeypot-Model Routing for Adversarial LLM Serving
...
## 19. $τ^τ$-Bench: An Environment for End-To-End, Realistic Agent Construction
...
## 20. SymbolicLight V2: Hybrid Neuromorphic Architecture and Sparse Execution for Low-Energy Language Inference
...
## 21. Python in the front, party in the Backline: compiling quantum workloads across CPUs, GPUs, and FPGAs
...
## 22. CWF: A Collaborative Writing Framework for Personalized and Reliable Popular Science Writing
...
## 23. UniMoMo: Expert Merging-Based MoE Acceleration for Large Recommendation Models
...
## 24. Detokenization Leaks: Reconstructing Local LLM Outputs From Cache Traces
...
## 25. Design Docs Are All You Need: An AI-native Machine-Learning Performance Tool
...
## 3. GLM 5.3 Optimizations, Part 1: Hybrid HiSparse Offloading in vLLM
...
## 4. Serving LLMs on Tenstorrent Hardware: Inside the vLLM TT Plugin
