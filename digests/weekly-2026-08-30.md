...
## 8. Agentic Autoresearch for Cell-Edge Power Control: Radically Redefining the Researcher's Role
...
## 9. Groundhog Bit-Flip Attack: Seeding Infinite Generation Loops in Mixture-of-Experts LLMs through Bit Flips
...
## 10. A Few Pages of Markdown: Committed AI Configuration and Lower Quality Cost after Coding-Agent Adoption
...
## 11. AsymSpec: Context-Asymmetric Speculative Decoding for Agentic LLMs
...
## 12. Can Coding Agents Build Robust Baselines? A Skill-Based Approach for Automating the Medical Imaging Model-Development Pipeline
...
## 14. Cost-Utility Alignment in LLM Agent Trajectories:Profiling,Attribution,Diagnosis,Adaptation,and Evaluation
...
## 15. AgentSpec: Speculative Decoding for Batch Inference of LLM Agents
...
## 16. Routed Graph Handoff: Adaptive Format Selection for Multi-Agent LLM Delegation
...
## 17. Paritok-4B: Intent-Conditioned Context Compression for Coding Agents
...
## 19. Pipeline-Native Transformers: Co-Designing Model Architecture and CPU Inference for Bandwidth-Efficient Autoregressive Decode
...
## 20. DSA: Evidence-Aware LLM-Agent Orchestration for Multi-Market Stock Research
...
## 21. One Model, Many Minds: Unlocking Multi-Agent Synergy in a Single Agent via Mixture of Roles
...
## 22. Don't Overthink, Don't Underthink: Toward Adaptive Reasoning in Agentic AI
...
## 23. Code World Model: Coding Agent as World Brain
...
## 24. SkillShield: Prompt-Space Security Skills for LLM Coding Agents
...
## 25. GRAIN: Bridging Name and Narrative Shifts in Real-World Graph Reasoning through Invariance-Rewarded Agentic RL
