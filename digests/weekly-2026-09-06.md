...
## 12. Skill-as-API: Confidential Multi-Agent Coordination for Agentic Software Engineering
...
## 13. AceSpec: An Asymmetric Edge-Cloud Collaborative Framework for Communication-Efficient LLM Inference
...
## 14. HyGRAIL: Cost-Aware and Evidence-Grounded Scientific Hypothesis Discovery over Knowledge Graphs
...
## 17. Privacy-Preserving Topology-Guided Safety for LLM-Based Multi-Agent Systems via Federated Graph Learning
...
## 19. World Model-Guided Reinforcement Learning via Counterfactual User Engagement Simulation
...
## 21. From Prompt to Prototype: Towards a Frontier LLM Driven RF Engineering Workflow
...
## 22. Unlocking Lossless Speedups in LLMs via Discrete Diffusion
...
## 23. A Phased Workflow for Operating LLM-Based Coding Agents
...
## 24. Update from Hell: Can Coding Agents Survive Hidden Breakage in Dependency Upgrades?
...
## 25. Cost-Effective Repository Exploration for Agentic Issue Localization

- arXiv ID: `2608.29675v1`
- 来源: arXiv API
- 类型: paper
- 发布时间: 2026-08-30
- 相关度得分: 24.0
