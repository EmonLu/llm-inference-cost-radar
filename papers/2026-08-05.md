...
## 1. Heterogeneous LLM Serving with General-Purpose Processing-Near-Memory for Retrieval-Based Sparse Attention
...
## 5. Agentic Coding in the Wild: Characterizing GitHub Copilot Traces at Production Scale
...
- 链接: [abs](https://arxiv.org/abs/2608.00101) | [pdf](https://arxiv.org/pdf/2608.00101v1)

## 6. ThAME: 3D Memory-Enabled Heterogeneous Accelerator for LLM Mixture of Experts
...
## 7. TokTier: Exact Stateful CPU+GPU Tokenization for Agentic LLM Serving
...
## 8. MoPET: Parameter-Efficient Mixture-of-Experts for Unified Medical Image Classification
...
## 9. The Agent Operating System (AOS): A Reference Operating Architecture for Distributed Agentic Systems
...
## 10. HorizonServe: Coordinating Request Scheduling with GPU Sharing for Omni-Model Serving
...
## 11. From Social Coding to Agentic Coding: Productivity and Relational Reconfiguration in Open-Source Communities
...
## 12. Learning Compositional Meta-Routing for Agentic Workflows: An Executable Benchmark
...
## 13. Cluster-Aware Over-the-Air Federated Learning with Energy-Harvesting Devices: From Global Training to Model Personalization
...
## 15. CascadeLUT: Information-Ordered Streaming Inference for Bandwidth-Constrained FPGAs

- arXiv ID: `2608.00720v1`
- 来源: arXiv cs.LG
- 类型: paper
- 发布时间: 2026-08-04
- 相关度得分: 35.0
