...
## 14. SwiftMem: Fast Agentic Memory via Query-aware Indexing
...
## 15. RIS-Kernel: A Model-Agnostic Architecture for Long-Context LLM Inference via Sparse Attention
