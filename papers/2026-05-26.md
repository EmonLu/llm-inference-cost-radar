...
## 4. Bandwidth-Aware LLM Inference on Heterogeneous Many-Core Supercomputers
...
## 5. LA-IMR: Latency-Aware, Predictive In-Memory Routing and Proactive Autoscaling for Tail-Latency-Sensitive Cloud Robotics
...
## 6. Influence-Inspired Spectral Rotations for Extreme Low-Bit LLM Quantization
...
## 8. ConceptM$^3$oE: Concept-Guided Multimodal Mixture of Experts for Interpretable Computational Pathology
...
## 9. RepetitionCurse: Measuring and Understanding Router Imbalance in Mixture-of-Experts LLMs under DoS Stress
...
## 10. Multi-Agent Systems are Mixtures of Experts: Who Becomes an Influencer?
...
## 11. Cross-Platform Fused MoE Dispatch in Triton: Portable Expert Routing Without CUDA
...
## 12. CoRe-Code: Collaborative Reinforcement Learning for Code Generation
...
## 13. LLM Agent Based Renewable Energy Forecasting Using Edge and IoT Data A Review of Solar Wind Weather and Grid Aware Decision Support
...
## 14. Bandwidth-Aware and Cost-Efficient Pipeline Parallel Scheduling in Geo-Distributed LLM Training
...
## 15. Optimus: Elastic Decoding for Efficient Diffusion LLM Serving
